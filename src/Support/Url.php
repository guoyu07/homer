...
class Url
{
     ...
     */
    public function __construct($scheme = null, $username = null, $password = null, $host = null, $port = 0,
        $path = null, array $parameters = [])
    {
    ...
    public static function valueOf($url)
    {
        ...
        return new self($scheme, $username, $password, $host, $port, $path, $parameters);
    }
    ...
    public function getBoolParameter($key, $default = false)
    {
        ...
        if ($value !== $this) {
            return in_array($value, ['yes', 'on', '1']);
        }
